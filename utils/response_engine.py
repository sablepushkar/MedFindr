...
def build_response(
    ...
    if ebm_result:
        factor_items = list(ebm_result.top_factors)
    ...
    notes = (
        "Response generated by MedFindr 09.0. "
        "Urgency assessment is rule-based and fully transparent. "
        "The EBM component currently uses a structured placeholder that matches the "
        "output format of a real InterpretML model. A trained model can be integrated without changing the pipeline."
    )
